...
export class AppComponent {
  ...
  public cliente = {
    "client": "THALO ASSIST",
    "id_country": "US",
    "img_cliente": "id_client4925a99cc2082411.png",
    "web": "https://thaloassist.page",
    "urlPrueba": "",
    "prefix": "TH",
    "type_platform": "1",
    "id_broker": "15",
    "email": "",
    "colors_platform": "{\n  \"COLOR_MENU_BACKEND\": \"#00799c\",\n  \"color_tr_table\": \"#c9c9c9\",\n  \"color_font_tr\": \"#e6e1e1\",\n  \"color_login\": \"#f6f6f6\",\n  \"color_menu\": \"#29a2c8\",\n  \"color_menu_barra\": \"#00799c\",\n  \"color_menu_barra_hover\": \"#97a5ae\",\n  \"color_font_tab\": \"#00799c\",\n  \"color_email_font\": \"#5c595a\",\n  \"email_shadow_table\": \"#f8f8f8\"\n}"
  };
  ...
  constructor(public platform: Platform,
    ...
    network.onConnect().subscribe(() => {
      ...
      this.userType ? this.navCtrl.navigateRoot('/list-orders') : navCtrl.navigateRoot('/login/TH');;
  ...
  sessionColores(colorsPlatform, cliente) {
    if (localStorage.getItem('paramAgency') != 'N/A' && localStorage.getItem('paramAgency')) {
      ...
      localStorage.setItem("nomClient", 'THALO ASSIST');
    }
  }
