    ...
    const modal = await this.modalCtrl.create({
      ...
      componentProps: {
        dataPlan: {
          ...
          "total_neto": "0.000",
          "USDTotal": "98.994",
          "USDTotal_costo": "29.983",
          "USDTotal_neto": "0.000",
          "tasa_cambio": 1,
          "moneda_local": "N",
          "moneda": "US$",
          "name_plan": "test no usar",
          "planfamiliar": 0,
          "planType": "dias",
          "max_age": 85,
          "min_age": 15,
          ...
          "numero_mayores": 1,
          "valorMayor": "59.51",
          "subTotalMayor": "52.077",
          "numero_menores": 1,
          "valorMenor": "53.62",
          "subTotalMenores": "46.917",
          "calc_new": "Y",
          "dir_habit": 'Y',
          "preOrden": null
        },
        dataVuelo: ["AL", "1", "23/09/2020", "29/09/2020", "Viajes por día", "24", ["45", '35'], null, "Albania", "World Wide"],
        rangEd: {
          edadMin: '15',
          edadMax: '85'
        },
  ...
  async modalPrecios(precios) {
    ...
    const modal = await this.modalCtrl.create({
      ...
      componentProps: {
        ...
        parametros: ["AL", "41", "22/09/2020", "28/09/2020", "Viajes por día", "24", [45, 20], null, "Albania", "World Wide"],
        paises: 'AL',
        idPreOrden: 825554
      }
    });
